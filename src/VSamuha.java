 ...
 * @author laptop
 */
public class VSamuha extends javax.swing.JFrame {
    ...
    public void fetch() {
        try {
            String q = "select id as 'Sn',name as 'Samuha Name', money_deposit as 'Money Deposited', money_withdraw as 'Money Withdraw', date_withdraw as 'Withdraw Date' ,date_deposit as 'Deposit Date' from vsamuha ORDER BY id DESC";
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Tsum, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(remaining, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23))
        );
        ...
        setSize(new java.awt.Dimension(1045, 718));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String sql = "insert into vsamuha (name,money_deposit,money_withdraw,date_withdraw,date_deposit) values(?,?,?,?,?)";
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (row >= 0) {
            try {
                String sql = "update vsamuha set name=?,money_deposit=?,money_withdraw=?,date_withdraw=?,date_deposit=? where id=?";
                pst = conn.prepareStatement(sql);
                pst.setString(1, (String) jComboBox1.getSelectedItem());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (row >= 0) {
            ...
            String sql = "delete from vsamuha where id = " + cell;
            try {
                pst = conn.prepareStatement(sql);
                pst.execute();
                fetch();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VSamuha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
